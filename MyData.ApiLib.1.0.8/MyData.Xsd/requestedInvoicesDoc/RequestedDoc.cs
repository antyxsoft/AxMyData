...
namespace MyData.Xsd {
    ...
    public partial class RequestedDoc {
        ...
        public RequestedDoc() {
            this.paymentMethodsDoc = new RequestedDocPaymentMethodsDoc();
            this.expensesClassificationsDoc = new RequestedDocExpensesClassificationsDoc();
            this.incomeClassificationsDoc = new RequestedDocIncomeClassificationsDoc();
            this.cancelledInvoicesDoc = new RequestedDocCancelledInvoicesDoc();
            this.invoicesDoc = new RequestedDocInvoicesDoc();
            this.continuationToken = new continuationTokenType();
        }
    }
}
