...
namespace MyData.Xsd
{
    ...
    public partial class InvoiceIncomeClassificationType
    {
        ...
        [XmlIgnoreAttribute()]
        private List<InvoicesIncomeClassificationDetailType> _invoicesIncomeClassificationDetails;
        
        [XmlElementAttribute("invoicesIncomeClassificationDetails")]
        public List<InvoicesIncomeClassificationDetailType> invoicesIncomeClassificationDetails
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="de">Ruft einen Wert ab, der angibt, ob die invoicesIncomeClassificationDetails-Collection leer ist.</para>
        ...
        public bool invoicesIncomeClassificationDetailsSpecified
        {
            get
            {
                return ((this.invoicesIncomeClassificationDetails != null) 
                            && (this.invoicesIncomeClassificationDetails.Count != 0));
            }
        }
        
        /// <summary>
        /// <para xml:lang="de">Initialisiert eine neue Instanz der <see cref="InvoiceIncomeClassificationType" /> Klasse.</para>
        ...
        {
            this._invoicesIncomeClassificationDetails = new List<InvoicesIncomeClassificationDetailType>();
        }
    }
}
